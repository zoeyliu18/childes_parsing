...
class BiaffineDependencyParser(Parser):
    ...
    def train(self, train, dev, test, buckets=32, batch_size=2000,
    ...
    def evaluate(self, data, buckets=8, batch_size=2000,
    ...
    def predict(self, data, pred=None, buckets=8, batch_size=2000,
